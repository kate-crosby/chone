...
- A brief discussion on version control
- Handy tools for making data public
- Measuring impacts of making data public
...
![plot of chunk unnamed-chunk-7](BIO_pres-figure/unnamed-chunk-7.png) 
...
Leaflet R is a javascript mapping applet
...
* __Check out CHONe datasets (link) __:__
  * [CHONe data packages] (http://chone.marinebiodiversity.ca/data/data-packages)


CHONe Open DATAsets (47 and counting)
======================================================
![alt text](CHONeData.png)
...
Acknowledgments: All CHONe researchers, CHONe staff, Dalhousie University, Memorial University, DFO, NSERC, Province of Newfoundland & Labrador
